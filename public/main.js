  ...
  fileReader.addEventListener('load', () => {
    ...
    if (fileName === 'ConstructionsSaveData.json') {
      ...
      <div class="alert alert-warning" role="alert">
        Setting the values higher than the recommended maximum may cause instability, unexpected behavior, or other unintended consequences in your game. Proceed with caution.
      </div>
